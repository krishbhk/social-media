...
function Profile() {
  ...
  return (
    ...
    <Row>{ userInfo.flag && postList.flag && 
          ...
          <div className="ms-5 card pt-3 my-sidebar">
            ...
            <div className="px-4 py-0 d-flex flex-column justify-content-center align-items-center">
              ...
              <Row className="mt-3 mb-3">
                ...
                <Col  className="text-center"><strong>{userInfo.data.follower.length}</strong><br></br><small className="text-muted">Followers</small></Col>
                <Col  className="text-center"><strong>{userInfo.data.following.length}</strong><br></br><small className="text-muted">Following</small></Col>
              </Row>
            </div>
          </div>
          </div>
      ...
      <h3 className="card p-3 me-5">Posts</h3>
